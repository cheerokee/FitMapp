 ...
 */
class Status extends \Cartola\Entity\Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cartola\\Entity\\Status' . "\0" . 'id', '' . "\0" . 'Cartola\\Entity\\Status' . "\0" . 'nome'];
        }
